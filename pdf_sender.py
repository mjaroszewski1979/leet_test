...
def get_pdf(company):
    ...
    txt_8 = f"I would be grateful for the opportunity to discuss my qualifications further and learn more about the opportunities at {company}. As a Software Developer, my goal is to continually increase my programming skills in order to present better solutions to my employers and their clients. I am particularly interested in working at {company} because of your reputation for developing innovative products and technologies. I believe that my experience make me a strong fit for your team, and I am eager to be a part of your company's growth and success. Thank you for taking the time to review my cover letter and attached resume."
    txt_9 = 'Kind Regards,'
